    ...
    class AvailableParametersTests
    {
        ...
        public void GetDiskDiameterValues_PositiveTest()
        {
            ...
            CollectionAssert.AreEqual(expected, actual, 
                "Геттер DiskDiameterValues возвращает неправильную " +
                "коллекцию допустимых значений диаметра диска");
        }
        ...
        public void GetBoltsCountValues_PositiveTest()
        {
            ...
            CollectionAssert.AreEqual(expected, actual,
                "Геттер BoltsCountValues возвращает неправильную " +
                "коллекцию допустимых значений количества болтов");
        }

        [Test(Description = 
            "Позитивный тест геттера BoltArrangementDiameterValues")]
        public void GetBoltArrangementDiameterValues_PositiveTest()
        {
            var expected = new List<double>() { 98, 100, 105, 108, 110,
                112, 114.3, 115, 118, 120, 127, 130, 139.7, 150, 160, 165 };
            var actual = _availableParameters.BoltArrangementDiameterValues;
            CollectionAssert.AreEqual(expected, actual,
                "Геттер BoltArrangementDiameterValues возвращает " +
                "неправильную коллекцию допустимых значений диаметра " +
                "расположения болтов");
        }

        [Test(Description = 
            "Позитивный тест геттера CentralHoleDiameterValues")]
        public void GetCentralHoleDiameterValues_PositiveTest()
        {
            var expected = new List<double>() 
            { 95.3, 98.1, 98.6, 108.5, 110.1 };
            var actual = _availableParameters.CentralHoleDiameterValues;
            CollectionAssert.AreEqual(expected, actual,
                "Геттер CentralHoleDiameterValues возвращает неправильную" +
                " коллекцию допустимых значений диаметра центрального " +
                "отверстия диска");
        }
        ...
        public void GetAirVentsCountValues_PositiveTest()
        {
            ...
            CollectionAssert.AreEqual(expected, actual,
                "Геттер AirVentsCountValues возвращает неправильную " +
                "коллекцию допустимых значений количества " +
        ...
        public void ChangeDiskDiameterDependentQuantities_NegativeTest
            (int diskDiameter)
        {
        ...
        public void ChangeDiskDiameterDependentQuantities_PositiveTest
            (int diskDiameter)
        {
            _availableParameters.ChangeDiskDiameterDependentQuantities
                (diskDiameter);
        ...
        [TestCase(16, 4, TestName = "Позитивный тест с корректным значением" +
            " диаметра диска и значением количества болтов 4")]
        [TestCase(16, 5, TestName = "Позитивный тест с корректным значением" +
            " диаметра диска и значением количества болтов 5")]
        [TestCase(16, 6, TestName = "Позитивный тест с корректным значением" +
            " диаметра диска и значением количества болтов 6")]
        ...
        [Test(Description = "Негативный тест метода " +
            "ChangeBoltArrangementDiameterDependentQuantities")]
        [TestCase(16, 5, 166, TestName = "Негативный тест с корректными " +
            "значениями диаметра диска и количества болтов, и значением " +
            "диаметра расположения болтов больше максимального")]
        [TestCase(16, 5, 97, TestName = "Негативный тест с корректными " +
            "значениями диаметра диска и количества болтов, и значением " +
            "диаметра расположения болтов меньше минимального")]
        [TestCase(16, 5, 115.5, TestName = "Негативный тест с корректными" +
            " значениями диаметра диска и количества болтов, и значением " +
            "диаметра расположения болтов в промежутке между " +
            "допустимыми значениями")]
        [TestCase(12, 3, 97, TestName = "Негативный тест с некорректными " +
            "значениями диаметра диска, количества и " +
            "диаметра расположения болтов")]
        [TestCase(12, 5, 139.7, TestName = "Негативный тест с некорректным" +
            " значением диаметра диска и корректными значениями " +
            "количества и диаметра расположения болтов")]
        [TestCase(16, 3, 139.7, TestName = "Негативный тест с некорректным" +
            " значением количества болтов и корректными значениями " +
            "диаметров диска и расположения болтов")]
        [TestCase(12, 3, 139.7, TestName = "Негативный тест с некорректными" +
            " значениями количества болтов и диаметра диска и корректным" +
            " значением диаметра расположения болтов")]
        ...
        [Test(Description = "Позитивный тест метода " +
            "ChangeBoltArrangementDiameterDependentQuantities")]
        [TestCase(16, 5, 98, TestName = "Позитивный тест с корректными " +
            "значениями диаметра и количества ботов, и значением " +
            "диаметра расположения болтов 98")]
        [TestCase(16, 5, 139.7, TestName = "Позитивный тест с корректными" +
            " значениями диаметра и количества ботов, и значением " +
            "диаметра расположения болтов 139.7")]
        [TestCase(16, 5, 165, TestName = "Позитивный тест с корректными " +
            "значениями диаметра и количества ботов, и значением " +
        ...
        [TestCase(AvailableValuesChangeType.BoltArrangementDiameterChanged, 
            TestName = "Позитивный тест запуска события с изменением " +
            "диаметра расположения болтов")]
