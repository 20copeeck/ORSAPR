...
namespace UnitTests
{
    ...
    class ParamsValidatorTests
    {
        ...
        [Test(Description = "Негативный тест метода IsValidDiskDiameter")]
        ...
        [Test(Description = "Позитивный тест метода IsValidDiskDiameter")]
        ...
        [TestCase(6, TestName =
            "Негативный тест со значением ширины диска меньше минимального")]
        [TestCase(11, TestName =
            "Негативный тест со значением ширины диска больше максимального")]
        ...
        [TestCase(6.5, TestName = "Позитивный тест со значением ширины диска 6.5")]
        [TestCase(7, TestName = "Позитивный тест со значением ширины диска 7")]
        [TestCase(8, TestName = "Позитивный тест со значением ширины диска 8")]
        [TestCase(10, TestName = "Позитивный тест со значением ширины диска 10")]
        ...
        [Test(Description = "Негативный тест метода IsValidBoltArrangementDiameter")]
        [TestCase(97, TestName =
            "Негативный тест со значением диаметра расположения болтов меньше минимального")]
        [TestCase(166, TestName =
            "Негативный тест со значением диаметра расположения болтов больше максимального")]
        [TestCase(139.5, TestName =
            "Негативный тест со значением диаметра расположения болтов " +
            "в промежутке между допустимыми значениями")]
        public void IsValidBoltArrangementDiameter_NegativeTest(double boltArrangementDiameter)
        {
            Assert.IsFalse(ParamsValidator.IsValidBoltArrangementDiameter
                (_availableParameters, boltArrangementDiameter));
        }

        [Test(Description = "Позитивный тест метода IsValidBoltArrangementDiameter")]
        [TestCase(98, TestName = 
            "Позитивный тест со значением диаметра расположения болтов 98")]
        [TestCase(139.7, TestName = 
            "Позитивный тест со значением диаметра расположения болтов 139.7")]
        [TestCase(165, TestName = 
            "Позитивный тест со значением диаметра расположения болтов 165")]
        public void IsValidBoltArrangementDiameter_PositiveTest(double boltArrangementDiameter)
        {
            Assert.IsTrue(ParamsValidator.IsValidBoltArrangementDiameter
                (_availableParameters, boltArrangementDiameter));
        }

        [Test(Description = "Негативный тест метода IsValidCentralHoleDiameter")]
        [TestCase(95, TestName =
            "Негативный тест со значением диаметра центрального отверстия меньше минимального")]
        [TestCase(111, TestName =
            "Негативный тест со значением диаметра центрального отверстия больше максимального")]
        [TestCase(98.5, TestName =
            "Негативный тест со значением диаметра центрального отверстия " +
            "в промежутке между допустимыми значениями")]
        public void IsValidCentralHoleDiameter_NegativeTest(double centralHoleDiameter)
        {
            Assert.IsFalse(ParamsValidator.IsValidCentralHoleDiameter
                (_availableParameters, centralHoleDiameter));
        }

        [Test(Description = "Позитивный тест метода IsValidCentralHoleDiameter")]
        [TestCase(95.3, TestName = "Позитивный тест со значением центрального отверстия 95.3")]
        [TestCase(98.1, TestName = "Позитивный тест со значением центрального отверстия 98.1")]
        [TestCase(98.6, TestName = "Позитивный тест со значением центрального отверстия 98.6")]
        [TestCase(108.5, TestName = "Позитивный тест со значением центрального отверстия 108.5")]
        [TestCase(110.1, TestName = "Позитивный тест со значением центрального отверстия 110.1")]
        public void IsValidCentralHoleDiameter_PositiveTest(double centralHoleDiameter)
        {
            Assert.IsTrue(ParamsValidator.IsValidCentralHoleDiameter
                (_availableParameters, centralHoleDiameter));
        }

        [Test(Description = "Негативный тест метода IsValidAirVentsCount")]
        [TestCase(11, TestName =
        ...
        public void IsValidAirVentsCount_NegativeTest(double airVentsCount)
        {
            Assert.IsFalse(ParamsValidator.IsValidAirVentsCount
                (_availableParameters, airVentsCount));
        }

        [Test(Description = "Позитивный тест метода IsValidAirVentsCount")]
        [TestCase(12, TestName = 
        ...
        [Test(Description = "Негативный тест метода IsValidAirVentsDiameter")]
        [TestCase(14, TestName =
            "Негативный тест со значением диаметра вентиляционных отверстий меньше минимального")]
        [TestCase(41, TestName =
            "Негативный тест со значением диаметра вентиляционных отверстий больше максимального")]
        [TestCase(-20, TestName =
            "Негативный тест с отрицательным значением диаметра вентиляционных отверстий")]
        public void IsValidAirVentsDiameter_NegativeTest(decimal airVentsDiameter)
        {
            Assert.IsFalse(ParamsValidator.IsValidAirVentsDiameter
                (_availableParameters, airVentsDiameter));
        }

        [Test(Description = "Позитивный тест метода IsValidAirVentsDiameter")]
        [TestCase(15, TestName =
        ...
        public void IsValidAirVentsDiameter_PositiveTest(decimal airVentsDiameter)
        {
