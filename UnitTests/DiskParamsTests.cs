...
namespace UnitTests
{
    ...
    public class DiskParamsTests
    {
        ...
        [Test(Description = 
            "Позитивный тест сеттера свойства DiskDiameter")]
        ...
        public void GetDiskDiameter_PositiveTest()
        {
            ...
            Assert.AreEqual(expected, actual,
                "Геттер DiskDiameter возвращает неправильное значение " +
                "диаметра диска");
        }

        [Test(Description = "Негативный тест сеттера свойства Width")]
        [TestCase(6, TestName = 
            "Негативный тест со значением ширины меньше минимальной")]
        [TestCase(10.5, TestName = 
            "Негативный тест со значением ширины больше максимальной")]
        [TestCase(7.5, TestName = 
            "Негативный тест со значением ширины в промежутке между " +
        ...
        public void GetBoltsCount_PositiveTest()
        {
            ...
            Assert.AreEqual(expected, actual,
                "Геттер BoltsCount возвращает неправильное значение " +
                "количества болтов");
        }

        [Test(Description = 
            "Негативный тест сеттера свойства BoltArrangementDiameter")]
        [TestCase(97, TestName = "Негативный тест со значением диаметра" +
            " расположения болтов меньше минимального")]
        [TestCase(170, TestName = "Негативный тест со значением диаметра" +
            " расположения болтов больше максимального")]
        [TestCase(112.5, TestName = "Негативный тест со значением диаметра" +
            " расположения болтов в промежутке между допустимыми значениями")]
        public void SetBoltArrangementDiameter_NegativeTest
        ...
        [Test(Description = 
            "Позитивный тест сеттера свойства BoltArrangementDiameter")]
        ...
        public void SetBoltArrangementDiameter_PositiveTest
            (double boltArrangementDiameter)
        {
            _diskParams.BoltArrangementDiameter = boltArrangementDiameter;
        }
        ...
        [Test(Description = 
            "Негативный тест сеттера свойства CentralHoleDiameter")]
        [TestCase(95, TestName = "Негативный тест со значением диаметра" +
            " центрального отверстия меньше минимального")]
        [TestCase(110.5, TestName ="Негативный тест со значением диаметра" +
            " центрального отверстия больше максимального")]
        [TestCase(100, TestName = "Негативный тест со значением диаметра" +
            " центрального отверстия в промежутке между допустимыми значениями")]
        public void SetCentralHoleDiameter_NegativeTest
        ...
        [Test(Description = 
            "Позитивный тест сеттера свойства CentralHoleDiameter")]
        [TestCase(95.3, TestName = "Позитивный тест со значением " +
            "диаметра центрального отверстия 95.3")]
        [TestCase(98.1, TestName = "Позитивный тест со значением " +
            "диаметра центрального отверстия 98.1")]
        [TestCase(98.6, TestName = "Позитивный тест со значением " +
            "диаметра центрального отверстия 98.6")]
        [TestCase(108.5, TestName = "Позитивный тест со значением " +
            "диаметра центрального отверстия 108.5")]
        [TestCase(110.1, TestName = "Позитивный тест со значением " +
            "диаметра центрального отверстия 110.1")]
        public void SetCentralHoleDiameter_PositiveTest
            (double centralHoleDiameter)
        {
            _diskParams.CentralHoleDiameter = centralHoleDiameter;
        }
        ...
        public void GetCentralHoleDiameter_PositiveTest()
        {
            ...
            Assert.AreEqual(expected, actual,
                "Геттер CentralHoleDiameter возвращает неправильное " +
                "значение диаметра центрального отверстия");
        }

        [Test(Description = 
            "Негативный тест сеттера свойства AirVentsCount")]
        ...
        [Test(Description = 
            "Позитивный тест сеттера свойства AirVentsCount")]
        ...
        public void GetAirVentsCount_PositiveTest()
        {
            ...
            Assert.AreEqual(expected, actual,
                "Геттер AirVentsCount возвращает неправильное значение" +
                " количества вентиляционных отверстий");
        }

        [Test(Description = 
            "Негативный тест сеттера свойства AirVentsDiameter")]
        ...
        public void SetAirVentsDiameter_NegativeTest
        ...
        [Test(Description = 
            "Позитивный тест сеттера свойства AirVentsDiameter")]
        ...
        public void GetAirVentsDiameter_PositiveTest()
        {
            ...
            Assert.AreEqual(expected, actual,
                "Геттер AirVentsDiameter возвращает неправильное " +
                "значение диаметра вентиляционных отверстий");
        }
    }
}
