...
namespace UnitTests
{
    ...
    class DoubleExtensionsTests
    {
        ...
        [TestCase(1.11022305e-16, TestName = "Негативный тест со " +
            "значением погрешности незначительно " +
            "превышающей максимальное")]
        [TestCase(1e-10, TestName = "Негативный тест со " +
            "значением погрешности значительно " +
            "превышающей максимальное")]
        ...
        [TestCase(1.1102229999e-16, TestName = "Позитивынй тест со " +
            "значением погрешности близкой к максимальной")]
        [TestCase(1e-20, TestName = "Позитивынй тест со значением " +
            "погрешности значительно меньшей максимальной")]
